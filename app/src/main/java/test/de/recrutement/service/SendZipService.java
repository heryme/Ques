 ...
 */
public class SendZipService extends APIService {
    public static String TAG = MainActivity.class.getName();
    private static final String RESOURCE_UPLOAD = BASE_URL + "/resourceupload";
    ...
    public static void sendZipFile(final Context context, HashMap<String,Object> params, final Success<JSONObject> successListener) {
       ...
       /* Map<String, Object> params = new HashMap<>();
        params.put("step", "2");*/
        logDebug("url >> " + RESOURCE_UPLOAD);
        MultipartRequest sendImage = new MultipartRequest(RESOURCE_UPLOAD,context, params,
