...
public class MultipartRequest extends Request<JSONObject> {
    ...
    public MultipartRequest(String url,Context context ,Map<String, Object> params, Response.Listener<JSONObject> listner, Response.ErrorListener errorListener) {
    ...
    private void buildEntity() {
        ...
        for (String key : params.keySet()) {
            ...
            if (params.get(key) instanceof File) {
                ...
                Log.d(TAG, "Key = " + key + " File=" + file + ", " + file.getAbsolutePath());
    ...
    public byte[] getBody() throws AuthFailureError {
        ...
        try {
            ...
            VolleyLog.e(context.getString(R.string.volly_error));
        }
